...
VALUES('flag','是否标记',1,'admin',systimestamp,'0');
INSERT INTO SYS_DICT(ID_,NAME_,SORT_,CREATED_BY,CREATED_TIME,DELETE_FLAG)
VALUES('res_type','资源类型',2,'admin',systimestamp,'0');
INSERT INTO SYS_DICT(ID_,NAME_,SORT_,CREATED_BY,CREATED_TIME,DELETE_FLAG)
VALUES('log_type','日志类型',3,'admin',systimestamp,'0');
INSERT INTO SYS_DICT(ID_,NAME_,SORT_,CREATED_BY,CREATED_TIME,DELETE_FLAG)
VALUES('job_status','任务状态',4,'admin',systimestamp,'0');

INSERT INTO SYS_DICT_ITEM(ID_,DICT_ID,CODE_,NAME_,SORT_,CREATED_BY,CREATED_TIME,DELETE_FLAG)
VALUES(sys_guid(),'flag','1','是',1,'admin',systimestamp,'0');
INSERT INTO SYS_DICT_ITEM(ID_,DICT_ID,CODE_,NAME_,SORT_,CREATED_BY,CREATED_TIME,DELETE_FLAG)
VALUES(sys_guid(),'flag','0','否',2,'admin',systimestamp,'0');

INSERT INTO SYS_DICT_ITEM(ID_,DICT_ID,CODE_,NAME_,SORT_,CREATED_BY,CREATED_TIME,DELETE_FLAG)
VALUES(sys_guid(),'res_type','1','菜单',1,'admin',systimestamp,'0');
INSERT INTO SYS_DICT_ITEM(ID_,DICT_ID,CODE_,NAME_,SORT_,CREATED_BY,CREATED_TIME,DELETE_FLAG)
VALUES(sys_guid(),'res_type','2','按钮',2,'admin',systimestamp,'0');
INSERT INTO SYS_DICT_ITEM(ID_,DICT_ID,CODE_,NAME_,SORT_,CREATED_BY,CREATED_TIME,DELETE_FLAG)
VALUES(sys_guid(),'res_type','3','接口',3,'admin',systimestamp,'0');

INSERT INTO SYS_DICT_ITEM(ID_,DICT_ID,CODE_,NAME_,SORT_,CREATED_BY,CREATED_TIME,DELETE_FLAG)
VALUES(sys_guid(),'log_type','0','操作日志',1,'admin',systimestamp,'0');
INSERT INTO SYS_DICT_ITEM(ID_,DICT_ID,CODE_,NAME_,SORT_,CREATED_BY,CREATED_TIME,DELETE_FLAG)
VALUES(sys_guid(),'log_type','1','登录日志',2,'admin',systimestamp,'0');

INSERT INTO SYS_DICT_ITEM(ID_,DICT_ID,CODE_,NAME_,SORT_,CREATED_BY,CREATED_TIME,DELETE_FLAG)
VALUES(sys_guid(),'job_status','0','已启动',1,'admin',systimestamp,'0');
INSERT INTO SYS_DICT_ITEM(ID_,DICT_ID,CODE_,NAME_,SORT_,CREATED_BY,CREATED_TIME,DELETE_FLAG)
VALUES(sys_guid(),'job_status','1','已停止',2,'admin',systimestamp,'0');
...
VALUES('organ','00','总机构','-1','admin',systimestamp,'0');

INSERT INTO SYS_USER(ID_,ACCOUNT_,PASSWORD_,NAME_,LOCKED_,ORGAN_ID,CREATED_BY,CREATED_TIME,DELETE_FLAG)
VALUES('admin','admin','df655ad8d3229f3269fad2a8bab59b6c','管理员','0','organ','admin',systimestamp,'0');

INSERT INTO SYS_USER_ORGAN(id_,user_id,organ_id)
VALUES(sys_guid(),'admin','organ');

INSERT INTO SYS_JOB(ID_,NAME_,CRON_,PARAM_,DESC_,STATUS_,CREATED_BY,CREATED_TIME,DELETE_FLAG)
VALUES(sys_guid(),'org.sevensoft.jrdp.api.job.LogJob','0 0 0 1/1 * ? *','30','清理系统日志，参数为保留天数','0','admin',systimestamp,'0');
INSERT INTO SYS_JOB(ID_,NAME_,CRON_,PARAM_,DESC_,STATUS_,CREATED_BY,CREATED_TIME,DELETE_FLAG)
VALUES(sys_guid(),'org.sevensoft.jrdp.api.job.JobLogJob','0 0 0 1/1 * ? *','30','清理任务日志，参数为保留天数','0','admin',systimestamp,'0');